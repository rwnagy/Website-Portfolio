export const projects = [
  {
    ...
    description: 'Простой система отслеживания ошибок, построен на стеке MERN. Это позволяет пользователям публиковать новые ошибки и удалять активные ошибки с помощью запросов axios.',
      image: '/images/1.jpg',
